...
CREATE TABLE "wait_staff" (
    ...
    CONSTRAINT "wait_staff_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "wait_staff" ADD CONSTRAINT "wait_staff_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
